...
import { formatThousands } from '../../components/RepositoryItem'
	...
	describe('RepositoryListContainer', () => {
		it('renders repository information correctly', () => {
			...
			repositoryItems.forEach((item, i) => {
				expect(
					within(item).getByText(repositories.edges[i].node.fullName)
				).toBeDefined()
				expect(
					within(item).getByText(repositories.edges[i].node.description)
				).toBeDefined()
				expect(
					within(item).getByText(repositories.edges[i].node.language)
				).toBeDefined()
				expect(
